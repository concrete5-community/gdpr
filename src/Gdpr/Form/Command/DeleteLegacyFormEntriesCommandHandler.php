...
class DeleteLegacyFormEntriesCommandHandler implements OutputAwareInterface
{
    use OutputAwareTrait;

    public function __invoke(DeleteLegacyFormEntriesCommand $command)
    {
        $app = Application::getFacadeApplication();

        try {
            /** @var \A3020\Gdpr\Form\Legacy\DeleteFormEntries $helper */
            $helper = $app->make(\A3020\Gdpr\Form\Legacy\DeleteFormEntries::class);
